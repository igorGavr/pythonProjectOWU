## 1 __repr__
## 2 можливість динамічно додавати поля класу та виводити екземпляр класу
## 3 дандр-метод __slots__
## 4 Наслідування
## 5 Інкапсуляція
## 6 Полиморфизм
## 7 Абстрактні класи
...
# 3 дандр-метод __slots__
# _ допомагає в визначенні полів (інші поля вписати неможливо крім тих які є в __slots__),
# а також економить память
# class User:
#     __slots__ = ('name', 'age')
#     count = 8
#
